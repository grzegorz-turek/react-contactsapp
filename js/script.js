...
(function(){
    ...
    var movieSet = [
        ...
        },
        {
            id: 2,
            ttl: 'Terminator',
            desc: 'The movie about two humanoids fighting for the future of human race. Career jump for Arnold Schwarzenegger',
        ...
        },
        {
            ...
            desc: 'The portrait of north wealthy states small towns societies shown on the pattern of mysterius and brutal murder of a young girl',
        ...
        },
        {
            id: 4,
            ttl: 'Platoon',
            desc: 'One of the major anti-war movies illustrating high-level of degeneration hitting human minds',
    ...
    var MoviesList = React.createClass({
        render: function () {
            var listOfMovies = movieSet.map(function (movieObjects) {
                return React.createElement(Movie, {key: movieObjects.id, movie: movieObjects});
            });
            return (
